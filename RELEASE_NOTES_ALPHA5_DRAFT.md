...
- Ctrl+Z is still accepted if a host forwards it, but Bitwig intercepts it before the plugin. Plain U is now the reliable plugin-local undo shortcut alongside the Undo button.
